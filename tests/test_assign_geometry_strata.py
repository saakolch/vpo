...
def row(idx: int, **metrics):
    base = {
        ...
        "reward_collinearity": "0.1",
        "effective_rank": "2.0",
        "pareto_fraction": "0.2",
        "eum_gap": "0.1",
        "winner_entropy_normalized": "0.5",
        "dominant_candidate_mass": "0.5",
        "target_regret": "0.1",
        "best_of_k_slope": "0.1",
        "best@30": "0.1",
...
def test_assign_strata_labels_prompt_rows():
    rows = [
        row(0, reward_collinearity=0.99, effective_rank=1.0),
        row(1, winner_entropy_normalized=0.01, dominant_candidate_mass=0.99),
        row(2, winner_entropy_normalized=0.99, target_regret=0.99),
    ...
    assert "reward_collinearity" in thresholds
